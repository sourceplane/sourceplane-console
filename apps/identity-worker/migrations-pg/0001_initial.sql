-- Identity schema for Supabase/Postgres (Hyperdrive path)
-- Schema: identity (identity-worker owned namespace)
-- All tables are prefixed with the "identity" schema to avoid cross-context collisions.
-- No cross-context foreign keys. Identifiers are UUIDs stored as TEXT to match
-- the application-generated IDs used across the platform.
